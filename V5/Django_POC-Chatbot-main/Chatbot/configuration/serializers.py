...
from .models import (
    BareActFileModel, VectorDBInformation, BareActsAgentConfiguration,
    WebsearchAgentConfiguration, ReflexionAgentConfiguration)

from app.models import (Extension_Data, Extension_Data_BSA, Extension_Data_BNS,
    Extension_Data_IT, Extension_Data_Web_Search, Extension_Data_DPDP,
    Githhub_Model_API)

class FileModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = BareActFileModel
        fields = '__all__'
