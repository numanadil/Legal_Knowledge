  ...
  chrome.scripting.executeScript({
    ...
    func: async () => {
      ...
      const buttonToKey = {
        ...
        // "Combined Acts":"Bare_Act_Reflexion_answer",
        // "Combined Web & Acts":"Web_Bare_Act_Reflexion_answers"
      };
      ...
      try {
        const response = await fetch("http://127.0.0.1:8000/VLANC-LegalAI/extension/all", {
          method: "POST",
